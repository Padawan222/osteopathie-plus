...
}`, "",{"version":3,"sources":["webpack://./src/assets/styles/_media-queries.scss","webpack://./src/index/osteopathie/osteopathie.scss"],"names":[],"mappings":"AAAA,8BAAA;AAMA,uCAAA;AAMA,6CAAA;AAMA,kBAAA;AChBA;EACE,aAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,yDAAA;EACA,sBAAA;EACA,2BAAA;EACA,YAAA;AAGF;;AADA;EACE,mDAAA;EACA,sBAAA;AAIF;;AAFA;EACE,iBAAA;EACA,2BAAA;AAKF;ADvBE;ECgBF;IAII,gBAAA;EAOF;AACF;AANE;EACE;IACE,UAAA;EAQJ;AACF;AANE;EACE,8BAAA;EACA,eAAA;EACA,sBAAA;EACA,aAAA;EACA,mBAAA;EACA,YAAA;EACA,qBAAA;EACA,4BAAA;EACA,cAAA;AAQJ;AAPI;EACE,sBAAA;EACA,oCAAA;AASN;;AALA;EACE,YAAA;EACA,WAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,aAAA;EACA,kBAAA;AAQF;AD3DE;EC2CF;IAUI,aAAA;EAUF;AACF;;AAPA;EACE,YAAA;EACA,UAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;EACA,kBAAA;EACA,mBAAA;AAUF;AD1EE;ECyDF;IASI,aAAA;IACA,iBAAA;EAYF;AACF;AD1EE;ECmDF;IAaI,aAAA;IACA,iBAAA;EAcF;AACF;AAbE;EACE,aAAA;EACA,iBAAA;AAeJ;AAbE;EACE,aAAA;AAeJ;;AAZA;EACE,4BAAA;EACA,gBAAA;EACA,eAAA;EACA,sBAAA;EACA,eAAA;EACA,gBAAA;AAeF;;AAbA;EACE,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;EACA,kBAAA;AAgBF;AD/GE;ECyFF;IAQI,aAAA;IACA,sBAAA;EAkBF;AACF;AD/GE;ECmFF;IAYI,aAAA;IACA,sBAAA;EAoBF;AACF;;AAlBA;EACE,YAAA;EACA,eAAA;AAqBF;;AAnBA;EACE,sBAAA;AAsBF;;AApBA;EACE,YAAA;EACA,UAAA;AAuBF;;AArBA;EACE,eAAA;AAwBF;;AAtBA;EACE,YAAA;EACA,WAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,aAAA;EACA,cAAA;EACA,iBAAA;EACA,mBAAA;EACA,qBAAA;EACA,iBAAA;EACA,cAAA;AAyBF;AAxBE;EACE,sBAAA;EACA,0BAAA;AA0BJ;ADhKE;ECuHF;IAkBI,0BAAA;EA2BF;AACF;AD/JE;ECiHF;IAqBI,0BAAA;EA6BF;AACF","sourcesContent":["/* Landscape phones and down */\r\n@mixin xs {\r\n  @media (max-width: 480px) {\r\n    @content;\r\n  }\r\n}\r\n/* Landscape phone to portrait tablet */\r\n@mixin sm {\r\n  @media (min-width: 480px) and (max-width: 1099px) {\r\n    @content;\r\n  }\r\n}\r\n/* Portrait tablet to landscape and desktop */\r\n@mixin md {\r\n  @media (min-width: 1100px) and (max-width: 1400px) {\r\n    @content;\r\n  }\r\n}\r\n/* Large desktop */\r\n@mixin xl {\r\n  @media (min-width: 1200px) and (max-width: 2559px) {\r\n    @content;\r\n  }\r\n}\r\n@mixin xxl {\r\n  @media (min-width: 2559px) {\r\n    @content;\r\n  }\r\n}\r\n","@use \"../../assets/styles/media-queries\" as *;\n\n.header-container {\n  height: 100vh;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  background-image: url(\"../../assets/images/lac-2.jpg\");\n  background-size: cover;\n  background-position: center;\n  z-index: 100;\n}\n.header-background {\n  background: url(../../assets/images/lac-2-v2.png);\n  background-size: cover;\n}\n.link-rdv {\n  margin-top: 10rem;\n  animation: link-rdv-anim 4s;\n  @include xs {\n    margin-top: 8rem;\n  }\n  @keyframes link-rdv-anim {\n    0% {\n      opacity: 0;\n    }\n  }\n  a {\n    background: rgba(0, 0, 0, 0.4);\n    font-size: 4rem;\n    letter-spacing: 0.1rem;\n    padding: 2rem;\n    border-radius: 5rem;\n    color: white;\n    text-decoration: none;\n    font-family: var(--ff-title);\n    transition: 1s;\n    &:hover {\n      color: var(--bordeaux);\n      background: rgba(#eee, 0.8);\n    }\n  }\n}\n.main-content {\n  height: auto;\n  width: auto;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding: 5rem;\n  text-align: center;\n  @include xs {\n    padding: 1rem;\n  }\n}\n\n.modalite-container {\n  height: 5rem;\n  width: 80%;\n  display: flex;\n  flex-direction: column;\n  margin: 2rem;\n  transition: 2s all;\n  border-radius: 3rem;\n  @include xs {\n    height: 40rem;\n    background: white;\n  }\n  @include sm {\n    height: 35rem;\n    background: white;\n  }\n  &:hover {\n    height: 30rem;\n    background: white;\n  }\n  &:hover > .span-modalite {\n    display: flex;\n  }\n}\nh3 {\n  font-family: var(--ff-title);\n  font-weight: 200;\n  font-size: 4rem;\n  color: var(--bordeaux);\n  cursor: pointer;\n  margin-top: 1rem;\n}\n.span-modalite {\n  display: none;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  transition: 2s all;\n  color: transparent;\n  @include xs {\n    display: flex;\n    color: var(--bordeaux);\n  }\n  @include sm {\n    display: flex;\n    color: var(--bordeaux);\n  }\n}\n.style-text-osteo {\n  margin: 1rem;\n  font-size: 2rem;\n}\n.style-text-osteo-active {\n  color: var(--bordeaux);\n}\n.osteo-text-container {\n  margin: 2rem;\n  width: 80%;\n}\n.osteo-text {\n  font-size: 2rem;\n}\n.questions-contact {\n  height: auto;\n  width: auto;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 2rem;\n  margin: 3rem 0;\n  background: white;\n  border-radius: 2rem;\n  text-decoration: none;\n  font-size: 1.8rem;\n  transition: 1s;\n  &:hover {\n    letter-spacing: 0.1rem;\n    text-decoration: underline;\n  }\n  @include xs {\n    text-decoration: underline;\n  }\n  @include sm {\n    text-decoration: underline;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
module.exports = __webpack_require__.p + "images/lac-2-v2.png";
